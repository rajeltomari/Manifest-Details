			...
			<table class="table100" cellpadding="3" border="0" width="100%">
				<tbody>
					<?php foreach ($top as $t): ?>
						<tr class="fontSmall">
							<td class="col_15"></td>
							<td class="col_150" colspan='2'><?php echo img($t['blank_img']);?></td>
							<td>
				...
				<?php foreach ($dept['pos'] as $pos): ?>
					...
					<?php if ($pos['open'] > 0 && $dept['type'] == 'playing'): ?>
						<tr class="open fontSmall hidden">
							<td class="col_15"></td>
							<td class="col_150" colspan='2'><?php echo img($pos['blank_img']);?></td>
							<td>
						...
						<?php foreach ($sub['pos'] as $spos): ?>
							...
							<?php if ($spos['open'] > 0 && $sub['type'] == 'playing'): ?>
								<tr class="open fontSmall hidden">
									<td class="col_15"></td>
									<td class="col_15"></td>
									<td class="col_150" colspan='2'><?php echo img($spos['blank_img']);?></td>
									<td>
